...
<div>
  ...
  <aside class="asideLeftIcons">
	  <nav>
		...
		<a href="createNewInterview.php?rsid=<?php echo $rSessionID ?>&rjob=<?php echo $rJob?>" class="aCreateNew">Create New</a> 
    ...
    <tr>
	  ...
	  <?php					
		...
		<!--<script> var id = <?php echo(json_encode($raw[0])); ?>;</script>--->
            <tr class="tableRow" href="interviewSchedule.php?rsid=<?php echo $rSessionID; ?>&int=<?php echo $raw[0] ?>&dur=<?php echo $raw[2] ?>">
