...
$Chart->ID = "Job_Offered_Candidates_Vs_University_Job_Offered_Candidates_Vs_University"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Job_Offered_Candidates_Vs_University_Job_Offered_Candidates_Vs_University", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Job_Offered_Candidates_Vs_University_Job_Offered_Candidates_Vs_University_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
