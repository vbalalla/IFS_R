...
define("EWR_PROJECT_ID", "{12843785-DCAE-4666-AA20-B39CE6A04C73}", TRUE); // Project ID
...
define("EWR_CONN_DB", 'recruit', TRUE);
...
define("EWR_RANDOM_KEY", '9FYheWSvyran69pT', TRUE); // Random key for encryption
