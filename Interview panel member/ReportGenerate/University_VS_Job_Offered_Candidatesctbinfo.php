...
$University_VS_Job_Offered_Candidates = NULL;

//
// Table class for University VS Job Offered Candidates
//
class crUniversity_VS_Job_Offered_Candidates extends crTableCrosstab {

//	var $SelectLimit = TRUE;
	var $University_Vs_Job_Position;
	var $University;
	var $dateCreated;
	...
	function __construct() {
		...
		$this->TableVar = 'University_VS_Job_Offered_Candidates';
		$this->TableName = 'University VS Job Offered Candidates';
		$this->TableType = 'REPORT';
		$this->ExportAll = TRUE;
		$this->ExportPageBreakCount = 0;

		// University
		$this->University = new crField('University_VS_Job_Offered_Candidates', 'University VS Job Offered Candidates', 'x_University', 'University', '`University`', 200, EWR_DATATYPE_STRING, -1);
		...
		// dateCreated
		$this->dateCreated = new crField('University_VS_Job_Offered_Candidates', 'University VS Job Offered Candidates', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		$this->Job_Offered_Candidates = new crField('University_VS_Job_Offered_Candidates', 'University VS Job Offered Candidates', 'x_Job_Offered_Candidates', 'Job_Offered_Candidates', '`Job_Offered_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('University_VS_Job_Offered_Candidates', 'University VS Job Offered Candidates', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		// University Vs Job Position
		$this->University_Vs_Job_Position = new crChart('University_VS_Job_Offered_Candidates', 'University VS Job Offered Candidates', 'University_Vs_Job_Position', 'University Vs Job Position', 'University', 'Job_Offered_Candidates', '', 5, 'SUM', 900, 500);
		$this->University_Vs_Job_Position->SqlSelect = "SELECT `University`, '', SUM(`Job_Offered_Candidates`) FROM ";
		$this->University_Vs_Job_Position->SqlGroupBy = "`University`";
		$this->University_Vs_Job_Position->SqlOrderBy = "";
		$this->University_Vs_Job_Position->SeriesDateType = "";
	}
