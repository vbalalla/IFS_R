...
$Chart->ID = "Rejected_Candidates_Vs_University_Rejected_Candidates_Vs_University"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Rejected_Candidates_Vs_University_Rejected_Candidates_Vs_University", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Rejected_Candidates_Vs_University_Rejected_Candidates_Vs_University_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
