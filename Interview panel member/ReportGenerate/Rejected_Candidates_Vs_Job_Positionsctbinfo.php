...
$Rejected_Candidates_Vs_Job_Positions = NULL;

//
// Table class for Rejected Candidates Vs Job Positions
//
class crRejected_Candidates_Vs_Job_Positions extends crTableCrosstab {
	var $Rejected_Candidates_Vs_Job_Positions;
	var $dateCreated;
	var $jbName;
	...
	function __construct() {
		...
		$this->TableVar = 'Rejected_Candidates_Vs_Job_Positions';
		$this->TableName = 'Rejected Candidates Vs Job Positions';
		...
		// dateCreated
		$this->dateCreated = new crField('Rejected_Candidates_Vs_Job_Positions', 'Rejected Candidates Vs Job Positions', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		// jbName
		$this->jbName = new crField('Rejected_Candidates_Vs_Job_Positions', 'Rejected Candidates Vs Job Positions', 'x_jbName', 'jbName', '`jbName`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Rejected_Candidates
		$this->Rejected_Candidates = new crField('Rejected_Candidates_Vs_Job_Positions', 'Rejected Candidates Vs Job Positions', 'x_Rejected_Candidates', 'Rejected_Candidates', '`Rejected_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('Rejected_Candidates_Vs_Job_Positions', 'Rejected Candidates Vs Job Positions', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		// Rejected Candidates Vs Job Positions
		$this->Rejected_Candidates_Vs_Job_Positions = new crChart($this->DBID, 'Rejected_Candidates_Vs_Job_Positions', 'Rejected Candidates Vs Job Positions', 'Rejected_Candidates_Vs_Job_Positions', 'Rejected Candidates Vs Job Positions', 'jbName', 'Rejected_Candidates', '', 5, 'SUM', 750, 450);
		$this->Rejected_Candidates_Vs_Job_Positions->SqlSelect = "SELECT `jbName`, '', SUM(`Rejected_Candidates`) FROM ";
		$this->Rejected_Candidates_Vs_Job_Positions->SqlGroupBy = "`jbName`";
		$this->Rejected_Candidates_Vs_Job_Positions->SqlOrderBy = "";
		$this->Rejected_Candidates_Vs_Job_Positions->SeriesDateType = "";
	}
	...
	function LoadColumnValues($filter = "") {
		...
		$nGrps = 1;
		$this->SummaryFields[0] = new crSummaryField('x_Rejected_Candidates', 'Rejected_Candidates', '`Rejected_Candidates`', 'SUM');
