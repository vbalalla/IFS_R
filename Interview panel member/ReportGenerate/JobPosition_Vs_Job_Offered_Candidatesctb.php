...
<?php include_once "JobPosition_Vs_Job_Offered_Candidatesctbinfo.php" ?>
<?php
...
$JobPosition_Vs_Job_Offered_Candidates_crosstab = NULL; // Initialize page object first

class crJobPosition_Vs_Job_Offered_Candidates_crosstab extends crJobPosition_Vs_Job_Offered_Candidates {
	...
	// Page object name
	var $PageObjName = 'JobPosition_Vs_Job_Offered_Candidates_crosstab';
	...
	function __construct() {
		...
		// Table object (JobPosition_Vs_Job_Offered_Candidates)
		if (!isset($GLOBALS["JobPosition_Vs_Job_Offered_Candidates"])) {
			$GLOBALS["JobPosition_Vs_Job_Offered_Candidates"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["JobPosition_Vs_Job_Offered_Candidates"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'JobPosition Vs Job Offered Candidates', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fJobPosition_Vs_Job_Offered_Candidatescrosstab";
	}
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_JobPosition_Vs_Job_Offered_Candidates\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_JobPosition_Vs_Job_Offered_Candidates',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fJobPosition_Vs_Job_Offered_Candidatescrosstab\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fJobPosition_Vs_Job_Offered_Candidatescrosstab\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fJobPosition_Vs_Job_Offered_Candidatescrosstab\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupPopup() {
		...
		// Get 'reset' command
			...
			if (strtolower($sCmd) == "reset") {
				$_SESSION["sel_JobPosition_Vs_Job_Offered_Candidates_YEAR__dateCreated"] = "";
				$this->ResetPager();
			}
		}
		...
		if (@$_GET["YEAR__dateCreated"] <> "") {
			...
			if (is_numeric($this->YEAR__dateCreated->QueryStringValue)) {
				$_SESSION["sel_JobPosition_Vs_Job_Offered_Candidates_YEAR__dateCreated"] = $this->YEAR__dateCreated->QueryStringValue;
				$this->ResetPager();
			}
		}
		$this->YEAR__dateCreated->SelectionList = @$_SESSION["sel_JobPosition_Vs_Job_Offered_Candidates_YEAR__dateCreated"];
	...
	function CheckFilter() {
		...
		// Year Filter
		if (@$_SESSION["sel_JobPosition_Vs_Job_Offered_Candidates_YEAR__dateCreated"] <> "")
			return TRUE;
		return FALSE;
	}
	...
	function RestoreFilterList() {
		...
		if (array_key_exists("sel_YEAR__dateCreated", $filter)) {
			...
			$_SESSION["sel_JobPosition_Vs_Job_Offered_Candidates_YEAR__dateCreated"] = $ar;
		}
	}
...
// Create page object
if (!isset($JobPosition_Vs_Job_Offered_Candidates_crosstab)) $JobPosition_Vs_Job_Offered_Candidates_crosstab = new crJobPosition_Vs_Job_Offered_Candidates_crosstab();
if (isset($Page)) $OldPage = $Page;
$Page = &$JobPosition_Vs_Job_Offered_Candidates_crosstab;
...
// Create page object
var JobPosition_Vs_Job_Offered_Candidates_crosstab = new ewr_Page("JobPosition_Vs_Job_Offered_Candidates_crosstab");

// Page properties
JobPosition_Vs_Job_Offered_Candidates_crosstab.PageID = "crosstab"; // Page ID
var EWR_PAGE_ID = JobPosition_Vs_Job_Offered_Candidates_crosstab.PageID;

// Extend page with Chart_Rendering function
JobPosition_Vs_Job_Offered_Candidates_crosstab.Chart_Rendering = 
...
JobPosition_Vs_Job_Offered_Candidates_crosstab.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
// Form object
var fJobPosition_Vs_Job_Offered_Candidatescrosstab = new ewr_Form("fJobPosition_Vs_Job_Offered_Candidatescrosstab");

// Validate method
fJobPosition_Vs_Job_Offered_Candidatescrosstab.Validate = function() {
...
fJobPosition_Vs_Job_Offered_Candidatescrosstab.Form_CustomValidate = 
...
fJobPosition_Vs_Job_Offered_Candidatescrosstab.ValidateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fJobPosition_Vs_Job_Offered_Candidatescrosstab.ValidateRequired = false; // No JavaScript validation
<?php } ?>
...
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<!-- Search form (begin) -->
<form name="fJobPosition_Vs_Job_Offered_Candidatescrosstab" id="fJobPosition_Vs_Job_Offered_Candidatescrosstab" class="form-inline ewForm ewExtFilterForm" action="<?php echo ewr_CurrentPage() ?>">
<?php $SearchPanelClass = ($Page->Filter <> "") ? " in" : " in"; ?>
<div id="fJobPosition_Vs_Job_Offered_Candidatescrosstab_SearchPanel" class="ewSearchPanel collapse<?php echo $SearchPanelClass ?>">
...
<div id="c_YEAR__dateCreated" class="ewCell form-group">
	...
	<select id="YEAR__dateCreated" class="form-control" name="YEAR__dateCreated" onchange="ewrForms['fJobPosition_Vs_Job_Offered_Candidatescrosstab'].Submit();">
<?php
...
<script type="text/javascript">
fJobPosition_Vs_Job_Offered_Candidatescrosstab.Init();
fJobPosition_Vs_Job_Offered_Candidatescrosstab.FilterList = <?php echo $Page->GetFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
<?php } ?>
...
<?php include "JobPosition_Vs_Job_Offered_Candidatesctbpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Job_Name">
		<div class="JobPosition_Vs_Job_Offered_Candidates_Job_Name"><span class="ewTableHeaderCaption"><?php echo $Page->Job_Name->FldCaption() ?></span></div>
	</td>
<?php } else { ?>
	<td data-field="Job_Name">
<?php if ($Page->SortUrl($Page->Job_Name) == "") { ?>
		<div class="ewTableHeaderBtn ewPointer JobPosition_Vs_Job_Offered_Candidates_Job_Name" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Job_Name) ?>',0);">
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_JobPosition_Vs_Job_Offered_Candidates_Job_Name"<?php echo $Page->Job_Name->ViewAttributes() ?>><?php echo $Page->Job_Name->GroupViewValue ?></span></td>
<?php } ?>
<!-- Dynamic columns begin -->
<?php
...
<?php } ?>
	<!-- Right slot -->
<a id="cht_JobPosition_Vs_Job_Offered_Candidates_job_position_vs_job_offered_Candidates"></a>
<div class="">
<div id="div_ctl_JobPosition_Vs_Job_Offered_Candidates_job_position_vs_job_offered_Candidates" class="ewChart">
<div id="div_JobPosition_Vs_Job_Offered_Candidates_job_position_vs_job_offered_Candidates" class="ewChartDiv"></div>
<!-- grid component -->
<div id="div_JobPosition_Vs_Job_Offered_Candidates_job_position_vs_job_offered_Candidates_grid" class="ewChartGrid"></div>
</div>
</div>
<?php

// Set up chart object
$Chart = &$Table->job_position_vs_job_offered_Candidates;
...
?>
<?php include_once "JobPosition_Vs_Job_Offered_Candidates_job_position_vs_job_offered_Candidateschart.php" ?>
<?php if ($Page->Export == "") { ?>
	</div>
	<!-- right container (end) -->
<div class="clearfix"></div>
