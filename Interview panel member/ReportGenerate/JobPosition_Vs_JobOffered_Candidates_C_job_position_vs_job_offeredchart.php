...
$Chart->ID = "JobPosition_Vs_JobOffered_Candidates_C_job_position_vs_job_offered"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_JobPosition_Vs_JobOffered_Candidates_C_job_position_vs_job_offered", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_JobPosition_Vs_JobOffered_Candidates_C_job_position_vs_job_offered_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
