...
<div>
  ...
  <aside class="asideLeftIcons">
	  <nav> 
		...
		<a href="evaluationCriteria.php?rsid=<?php echo $rSessionID?>&rname=<?php echo $rName?>&rjob=<?php echo $rJob?>&rdate=<?php echo $rDate?>&rstatus=<?php echo $rStatus?>" class="aCreateNew">Create New</a> 
