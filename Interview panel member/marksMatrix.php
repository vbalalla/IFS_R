...
<div>
  ...
  <tr>
  <td>
  <form role="form" action="changeCandidateStatus.php?cand=<?php echo $id;?>&int=<?php echo $intID;?>&criteria=<?php echo $criteriaID?>" method="post">
  ...
  <?php    for($i=0;$i<$count[0];$i++){ ?>
    <tr>
	  ...
	  echo "Comment of Panel Member $ii" ;?>
       <textarea rows="2" cols="10"  name="comments" value"<?php echo $rows[$i][3];?>" class="textInputEnterCandidateDetails" placeholder="<?php echo $rows[$i][3];?>" disabled></textarea>
  ...
  <table width="100%" border="1" id="tableCommon">
  <thead>
    <tr>
...
<?php      for( $j=0;$j<$count2[0];$j++){ ?>
      <td align="center"><?php echo $rows[$i][$j+4];?></td>
<?php }      ?>
    ...
    <tr>
	  ...
	  <p>
      <input type="submit" value="Save" id="marksMatrixBtn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="reset" value="Cancel" id="marksMatrixBtn" >
      <br/>
