...
$Job_Position_Vs_Rejected_Candidates = NULL;

//
// Table class for Job Position Vs Rejected Candidates
//
class crJob_Position_Vs_Rejected_Candidates extends crTableCrosstab {

//	var $SelectLimit = TRUE;
	var $Job_Position_Vs_Number_of_Rejected_Candidates;
	var $dateCreated;
	var $jbName;
	var $Rejected_Candidates;
	...
	function __construct() {
		...
		$this->TableVar = 'Job_Position_Vs_Rejected_Candidates';
		$this->TableName = 'Job Position Vs Rejected Candidates';
		$this->TableType = 'REPORT';
		$this->ExportAll = TRUE;
		$this->ExportPageBreakCount = 0;

		// dateCreated
		$this->dateCreated = new crField('Job_Position_Vs_Rejected_Candidates', 'Job Position Vs Rejected Candidates', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		// jbName
		$this->jbName = new crField('Job_Position_Vs_Rejected_Candidates', 'Job Position Vs Rejected Candidates', 'x_jbName', 'jbName', '`jbName`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Rejected_Candidates
		$this->Rejected_Candidates = new crField('Job_Position_Vs_Rejected_Candidates', 'Job Position Vs Rejected Candidates', 'x_Rejected_Candidates', 'Rejected_Candidates', '`Rejected_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		$this->Rejected_Candidates->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->fields['Rejected_Candidates'] = &$this->Rejected_Candidates;
		$this->Rejected_Candidates->DateFilter = "";
		$this->Rejected_Candidates->SqlSelect = "";
		$this->Rejected_Candidates->SqlOrderBy = "";

		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('Job_Position_Vs_Rejected_Candidates', 'Job Position Vs Rejected Candidates', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		// Job Position Vs Number of Rejected Candidates
		$this->Job_Position_Vs_Number_of_Rejected_Candidates = new crChart('Job_Position_Vs_Rejected_Candidates', 'Job Position Vs Rejected Candidates', 'Job_Position_Vs_Number_of_Rejected_Candidates', 'Job Position Vs Number of Rejected Candidates', 'jbName', 'Rejected_Candidates', '', 5, 'SUM', 900, 500);
		$this->Job_Position_Vs_Number_of_Rejected_Candidates->SqlSelect = "SELECT `jbName`, '', SUM(`Rejected_Candidates`) FROM ";
		$this->Job_Position_Vs_Number_of_Rejected_Candidates->SqlGroupBy = "`jbName`";
		$this->Job_Position_Vs_Number_of_Rejected_Candidates->SqlOrderBy = "";
		$this->Job_Position_Vs_Number_of_Rejected_Candidates->SeriesDateType = "";
	}
	...
	function getSummaryField() {
		return ($this->SummaryField <> "") ? $this->SummaryField : "`Rejected_Candidates`";
	}
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`jobpositionvsrejected`";
	}
	...
	function getSqlCrosstabYear() {
		return ($this->_SqlCrosstabYear <> "") ? $this->_SqlCrosstabYear : "SELECT DISTINCT YEAR(`dateCreated`) AS `YEAR__dateCreated` FROM `jobpositionvsrejected` ORDER BY YEAR(`dateCreated`)";
	}
