...
$Chart->ID = "JobPosition_JobOffered_C_job_position_vs_job_offered"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_JobPosition_JobOffered_C_job_position_vs_job_offered", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_JobPosition_JobOffered_C_job_position_vs_job_offered_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
