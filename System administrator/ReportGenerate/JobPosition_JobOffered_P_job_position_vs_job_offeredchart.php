...
// Set up chart
//$Chart = &$Table->P_job_position_vs_job_offered;
// Initialize chart data

$Chart->ID = "JobPosition_JobOffered_P_job_position_vs_job_offered"; // Chart ID
$Chart->SetChartParms(array(array("type", "6", FALSE),
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_JobPosition_JobOffered_P_job_position_vs_job_offered", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_JobPosition_JobOffered_P_job_position_vs_job_offered_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
