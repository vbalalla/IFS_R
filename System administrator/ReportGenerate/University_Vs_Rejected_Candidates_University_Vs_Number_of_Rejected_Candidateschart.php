...
$Chart->ID = "University_Vs_Rejected_Candidates_University_Vs_Number_of_Rejected_Candidates"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_University_Vs_Rejected_Candidates_University_Vs_Number_of_Rejected_Candidates", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_University_Vs_Rejected_Candidates_University_Vs_Number_of_Rejected_Candidates_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
