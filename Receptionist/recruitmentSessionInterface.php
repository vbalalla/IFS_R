...
<div>
  ...
  <table width="83%" border="1" align="center" cellpadding="5" class="sortable" id="existingSessionsTable">
	...
	<script> var id = <?php echo(json_encode($row['RSID'])); ?>;</script>
		<tr>			
			<td id=<?php echo $row['RSID']?> href="interviews.php?rsid=<?php echo $row['RSID']?>&rname=<?php echo $row['name']?>&rjob=<?php echo $row['jbName']?>&rdate=<?php echo $row['dateCreated']?>&rstatus=<?php echo $row['status']?>"><?php echo $row['name']?></td>
			<td id=<?php echo $row['RSID']?> href="interviews.php?rsid=<?php echo $row['RSID']?>&rname=<?php echo $row['name']?>&rjob=<?php echo $row['jbName']?>&rdate=<?php echo $row['dateCreated']?>&rstatus=<?php echo $row['status']?>"><?php echo $row['jbName']?></td>
			<td id=<?php echo $row['RSID']?> href="interviews.php?rsid=<?php echo $row['RSID']?>&rname=<?php echo $row['name']?>&rjob=<?php echo $row['jbName']?>&rdate=<?php echo $row['dateCreated']?>&rstatus=<?php echo $row['status']?>"><?php echo $row['dateCreated']?></td>
			<td id=<?php echo $row['RSID']?> href="interviews.php?rsid=<?php echo $row['RSID']?>&rname=<?php echo $row['name']?>&rjob=<?php echo $row['jbName']?>&rdate=<?php echo $row['dateCreated']?>&rstatus=<?php echo $row['status']?>"><?php echo $row['status']?></td>
		</tr>
		<?php }?>
    </tbody>
  </table>
