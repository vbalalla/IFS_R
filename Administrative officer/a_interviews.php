  ...
  <tbody>
    <tr>
	  ...
	  <?php	
        ...
        <?php if($raw[2]==0){?>
            <tr class="tableRow" href="evaluationCriteriaAdd.php?rsid=<?php echo $rSessionID?>&rname=<?php echo $rName; ?>&rjob=<?php echo $rJob; ?>&rdate=<?php echo $rDate; ?>&rstatus=<?php echo $rStatus; ?>&int=<?php echo $raw[0]?>">
                <td class="tableData" name="intName" id = <?php echo $raw[0] ?> ><?php echo $raw[1] ?></td>
            </tr>
            <?php } else{ ?>
            <tr class="tableRow" href="interviewCandidates.php?rsid=<?php echo $rSessionID?>&rname=<?php echo $rName; ?>&rjob=<?php echo $rJob; ?>&rdate=<?php echo $rDate; ?>&rstatus=<?php echo $rStatus; ?>&int=<?php echo $raw[0]?>">
                <td class="tableData" name="intName" id = <?php echo $raw[0] ?> ><?php echo $raw[1] ?></td>
            </tr>
         <?php } ?>
