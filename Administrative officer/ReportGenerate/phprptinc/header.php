...
<meta name="generator" content="PHP Report Maker v9.0.0">
	...
	<style type="text/css">
		.aBack {
			...
			padding-right: 5px;
			color: #281A2B;
			background-image: url(../images/recruitmentSession/back.png);
		...
		.aHelp {
			...
			padding-left: 70px;
			color: #281A2B;
			background-image: url(../images/recruitmentSession/HelpButton.png);
			background-repeat: no-repeat;
			padding-top: 11px;
			padding-bottom: 24px;
			-webkit-transition: all 0.3s ease 0s;
		...
		.aHelp:hover {
			background-image: url(../images/recruitmentSession/HelpButton2.png);
			padding-top: 3px;
		}
		.aBack:hover {
			background-image: url(../images/recruitmentSession/back2.png);
			padding-top: 3px;
		}
	</style>

</head>
<body style="padding-left:6%; padding-right:6%; padding-top:1%; background-image: url(../images/bg.jpg);font-family: 'OpenSans Regular';background-size: cover">
...
<?php include_once "menu.php" ?>
			...
			<div id="ewContentColumn" class="ewContentColumn" style="background-color: #E9E1E1">
				<!-- right column (begin) -->
