...
$Job_Offered_Candidates_Vs_Job_Positions = NULL;

//
// Table class for Job Offered Candidates Vs Job Positions
//
class crJob_Offered_Candidates_Vs_Job_Positions extends crTableCrosstab {
	var $Job_Offered_Candidates_Vs_Job_Positions;
	var $Job_Name;
	...
	function __construct() {
		...
		$this->TableVar = 'Job_Offered_Candidates_Vs_Job_Positions';
		$this->TableName = 'Job Offered Candidates Vs Job Positions';
		...
		// Job_Name
		$this->Job_Name = new crField('Job_Offered_Candidates_Vs_Job_Positions', 'Job Offered Candidates Vs Job Positions', 'x_Job_Name', 'Job_Name', '`Job_Name`', 200, EWR_DATATYPE_STRING, -1);
		$this->Job_Name->GroupingFieldId = 1;
		$this->fields['Job_Name'] = &$this->Job_Name;
		$this->Job_Name->DateFilter = "";
		$this->Job_Name->SqlSelect = "SELECT DISTINCT `Job_Name` FROM " . $this->getSqlFrom();
		$this->Job_Name->SqlOrderBy = "`Job_Name`";

		// Job_Offered_Candidates
		$this->Job_Offered_Candidates = new crField('Job_Offered_Candidates_Vs_Job_Positions', 'Job Offered Candidates Vs Job Positions', 'x_Job_Offered_Candidates', 'Job_Offered_Candidates', '`Job_Offered_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// dateCreated
		$this->dateCreated = new crField('Job_Offered_Candidates_Vs_Job_Positions', 'Job Offered Candidates Vs Job Positions', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('Job_Offered_Candidates_Vs_Job_Positions', 'Job Offered Candidates Vs Job Positions', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		// Job Offered Candidates Vs Job Positions
		$this->Job_Offered_Candidates_Vs_Job_Positions = new crChart($this->DBID, 'Job_Offered_Candidates_Vs_Job_Positions', 'Job Offered Candidates Vs Job Positions', 'Job_Offered_Candidates_Vs_Job_Positions', 'Job Offered Candidates Vs Job Positions', 'Job_Name', 'Job_Offered_Candidates', '', 5, 'SUM', 750, 450);
		$this->Job_Offered_Candidates_Vs_Job_Positions->SqlSelect = "SELECT `Job_Name`, '', SUM(`Job_Offered_Candidates`) FROM ";
		$this->Job_Offered_Candidates_Vs_Job_Positions->SqlGroupBy = "`Job_Name`";
		$this->Job_Offered_Candidates_Vs_Job_Positions->SqlOrderBy = "";
		$this->Job_Offered_Candidates_Vs_Job_Positions->SeriesDateType = "";
	}
