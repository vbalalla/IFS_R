...
$JobPosition_Vs_JobOffered_Candidates = NULL;

//
// Table class for JobPosition Vs JobOffered Candidates
//
class crJobPosition_Vs_JobOffered_Candidates extends crTableCrosstab {
...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		$this->TableVar = 'JobPosition_Vs_JobOffered_Candidates';
		$this->TableName = 'JobPosition Vs JobOffered Candidates';
		$this->TableType = 'REPORT';
		$this->ExportAll = TRUE;
		$this->ExportPageBreakCount = 0;

		// Job_Name
		$this->Job_Name = new crField('JobPosition_Vs_JobOffered_Candidates', 'JobPosition Vs JobOffered Candidates', 'x_Job_Name', 'Job_Name', '`Job_Name`', 200, EWR_DATATYPE_STRING, -1);
		...
		$this->Job_Offered_Candidates = new crField('JobPosition_Vs_JobOffered_Candidates', 'JobPosition Vs JobOffered Candidates', 'x_Job_Offered_Candidates', 'Job_Offered_Candidates', '`Job_Offered_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// dateCreated
		$this->dateCreated = new crField('JobPosition_Vs_JobOffered_Candidates', 'JobPosition Vs JobOffered Candidates', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('JobPosition_Vs_JobOffered_Candidates', 'JobPosition Vs JobOffered Candidates', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		$this->C_job_position_vs_job_offered = new crChart('JobPosition_Vs_JobOffered_Candidates', 'JobPosition Vs JobOffered Candidates', 'C_job_position_vs_job_offered', 'C job position vs job offered', 'Job_Name', 'Job_Offered_Candidates', '', 5, 'SUM', 970, 500);
