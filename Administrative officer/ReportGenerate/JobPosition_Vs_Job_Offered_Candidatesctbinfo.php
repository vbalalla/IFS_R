...
$JobPosition_Vs_Job_Offered_Candidates = NULL;

//
// Table class for JobPosition Vs Job Offered Candidates
//
class crJobPosition_Vs_Job_Offered_Candidates extends crTableCrosstab {

//	var $SelectLimit = TRUE;
	var $job_position_vs_job_offered_Candidates;
	var $Job_Name;
	...
	function __construct() {
		...
		$this->TableVar = 'JobPosition_Vs_Job_Offered_Candidates';
		$this->TableName = 'JobPosition Vs Job Offered Candidates';
		$this->TableType = 'REPORT';
		$this->ExportAll = TRUE;
		$this->ExportPageBreakCount = 0;

		// Job_Name
		$this->Job_Name = new crField('JobPosition_Vs_Job_Offered_Candidates', 'JobPosition Vs Job Offered Candidates', 'x_Job_Name', 'Job_Name', '`Job_Name`', 200, EWR_DATATYPE_STRING, -1);
		...
		$this->Job_Offered_Candidates = new crField('JobPosition_Vs_Job_Offered_Candidates', 'JobPosition Vs Job Offered Candidates', 'x_Job_Offered_Candidates', 'Job_Offered_Candidates', '`Job_Offered_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// dateCreated
		$this->dateCreated = new crField('JobPosition_Vs_Job_Offered_Candidates', 'JobPosition Vs Job Offered Candidates', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('JobPosition_Vs_Job_Offered_Candidates', 'JobPosition Vs Job Offered Candidates', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		// job position vs job offered Candidates
		$this->job_position_vs_job_offered_Candidates = new crChart('JobPosition_Vs_Job_Offered_Candidates', 'JobPosition Vs Job Offered Candidates', 'job_position_vs_job_offered_Candidates', 'job position vs job offered Candidates', 'Job_Name', 'Job_Offered_Candidates', '', 5, 'SUM', 900, 500);
		$this->job_position_vs_job_offered_Candidates->SqlSelect = "SELECT `Job_Name`, '', SUM(`Job_Offered_Candidates`) FROM ";
		$this->job_position_vs_job_offered_Candidates->SqlGroupBy = "`Job_Name`";
		$this->job_position_vs_job_offered_Candidates->SqlOrderBy = "";
		$this->job_position_vs_job_offered_Candidates->SeriesDateType = "";
	}
