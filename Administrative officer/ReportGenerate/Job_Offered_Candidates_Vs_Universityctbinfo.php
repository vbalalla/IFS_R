...
$Job_Offered_Candidates_Vs_University = NULL;

//
// Table class for Job Offered Candidates Vs University
//
class crJob_Offered_Candidates_Vs_University extends crTableCrosstab {
	var $Job_Offered_Candidates_Vs_University;
	var $University;
	var $dateCreated;
	...
	function __construct() {
		...
		$this->TableVar = 'Job_Offered_Candidates_Vs_University';
		$this->TableName = 'Job Offered Candidates Vs University';
		...
		// University
		$this->University = new crField('Job_Offered_Candidates_Vs_University', 'Job Offered Candidates Vs University', 'x_University', 'University', '`University`', 200, EWR_DATATYPE_STRING, -1);
		...
		// dateCreated
		$this->dateCreated = new crField('Job_Offered_Candidates_Vs_University', 'Job Offered Candidates Vs University', 'x_dateCreated', 'dateCreated', '`dateCreated`', 133, EWR_DATATYPE_DATE, 5);
		...
		$this->Job_Offered_Candidates = new crField('Job_Offered_Candidates_Vs_University', 'Job Offered Candidates Vs University', 'x_Job_Offered_Candidates', 'Job_Offered_Candidates', '`Job_Offered_Candidates`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// YEAR__dateCreated
		$this->YEAR__dateCreated = new crField('Job_Offered_Candidates_Vs_University', 'Job Offered Candidates Vs University', 'x_YEAR__dateCreated', 'YEAR__dateCreated', 'YEAR(`dateCreated`)', 3, EWR_DATATYPE_NUMBER, 0, FALSE);
		...
		// Job Offered Candidates Vs University
		$this->Job_Offered_Candidates_Vs_University = new crChart($this->DBID, 'Job_Offered_Candidates_Vs_University', 'Job Offered Candidates Vs University', 'Job_Offered_Candidates_Vs_University', 'Job Offered Candidates Vs University', 'University', 'Job_Offered_Candidates', '', 5, 'SUM', 750, 450);
		$this->Job_Offered_Candidates_Vs_University->SqlSelect = "SELECT `University`, '', SUM(`Job_Offered_Candidates`) FROM ";
		$this->Job_Offered_Candidates_Vs_University->SqlGroupBy = "`University`";
		$this->Job_Offered_Candidates_Vs_University->SqlOrderBy = "";
		$this->Job_Offered_Candidates_Vs_University->SeriesDateType = "";
	}
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`universityvsjobofferedcandidates`";
	}
	...
	function getSqlCrosstabYear() {
		return ($this->_SqlCrosstabYear <> "") ? $this->_SqlCrosstabYear : "SELECT DISTINCT YEAR(`dateCreated`) AS `YEAR__dateCreated` FROM `universityvsjobofferedcandidates` ORDER BY YEAR(`dateCreated`)";
	}
	...
	function LoadColumnValues($filter = "") {
		...
		$nGrps = 1;
		$this->SummaryFields[0] = new crSummaryField('x_Job_Offered_Candidates', 'Job_Offered_Candidates', '`Job_Offered_Candidates`', 'SUM');
