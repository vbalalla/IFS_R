...
<?php include_once "University_VS_Job_Offered_Candidatesctbinfo.php" ?>
<?php
...
$University_VS_Job_Offered_Candidates_crosstab = NULL; // Initialize page object first

class crUniversity_VS_Job_Offered_Candidates_crosstab extends crUniversity_VS_Job_Offered_Candidates {
	...
	// Page object name
	var $PageObjName = 'University_VS_Job_Offered_Candidates_crosstab';
	...
	function __construct() {
		...
		// Table object (University_VS_Job_Offered_Candidates)
		if (!isset($GLOBALS["University_VS_Job_Offered_Candidates"])) {
			$GLOBALS["University_VS_Job_Offered_Candidates"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["University_VS_Job_Offered_Candidates"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'University VS Job Offered Candidates', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fUniversity_VS_Job_Offered_Candidatescrosstab";
	}
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_University_VS_Job_Offered_Candidates\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_University_VS_Job_Offered_Candidates',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fUniversity_VS_Job_Offered_Candidatescrosstab\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fUniversity_VS_Job_Offered_Candidatescrosstab\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fUniversity_VS_Job_Offered_Candidatescrosstab\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupPopup() {
		...
		// Get 'reset' command
			...
			if (strtolower($sCmd) == "reset") {
				$_SESSION["sel_University_VS_Job_Offered_Candidates_YEAR__dateCreated"] = "";
				$this->ResetPager();
			}
		}
		...
		if (@$_GET["YEAR__dateCreated"] <> "") {
			...
			if (is_numeric($this->YEAR__dateCreated->QueryStringValue)) {
				$_SESSION["sel_University_VS_Job_Offered_Candidates_YEAR__dateCreated"] = $this->YEAR__dateCreated->QueryStringValue;
				$this->ResetPager();
			}
		}
		$this->YEAR__dateCreated->SelectionList = @$_SESSION["sel_University_VS_Job_Offered_Candidates_YEAR__dateCreated"];
	...
	function CheckFilter() {
		...
		// Year Filter
		if (@$_SESSION["sel_University_VS_Job_Offered_Candidates_YEAR__dateCreated"] <> "")
			return TRUE;
		return FALSE;
	}
	...
	function RestoreFilterList() {
		...
		if (array_key_exists("sel_YEAR__dateCreated", $filter)) {
			...
			$_SESSION["sel_University_VS_Job_Offered_Candidates_YEAR__dateCreated"] = $ar;
		}
	}
...
// Create page object
if (!isset($University_VS_Job_Offered_Candidates_crosstab)) $University_VS_Job_Offered_Candidates_crosstab = new crUniversity_VS_Job_Offered_Candidates_crosstab();
if (isset($Page)) $OldPage = $Page;
$Page = &$University_VS_Job_Offered_Candidates_crosstab;
...
// Create page object
var University_VS_Job_Offered_Candidates_crosstab = new ewr_Page("University_VS_Job_Offered_Candidates_crosstab");

// Page properties
University_VS_Job_Offered_Candidates_crosstab.PageID = "crosstab"; // Page ID
var EWR_PAGE_ID = University_VS_Job_Offered_Candidates_crosstab.PageID;

// Extend page with Chart_Rendering function
University_VS_Job_Offered_Candidates_crosstab.Chart_Rendering = 
...
University_VS_Job_Offered_Candidates_crosstab.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
// Form object
var fUniversity_VS_Job_Offered_Candidatescrosstab = new ewr_Form("fUniversity_VS_Job_Offered_Candidatescrosstab");

// Validate method
fUniversity_VS_Job_Offered_Candidatescrosstab.Validate = function() {
...
fUniversity_VS_Job_Offered_Candidatescrosstab.Form_CustomValidate = 
...
fUniversity_VS_Job_Offered_Candidatescrosstab.ValidateRequired = true; // Uses JavaScript validation
<?php } else { ?>
fUniversity_VS_Job_Offered_Candidatescrosstab.ValidateRequired = false; // No JavaScript validation
<?php } ?>
...
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
<!-- Search form (begin) -->
<form name="fUniversity_VS_Job_Offered_Candidatescrosstab" id="fUniversity_VS_Job_Offered_Candidatescrosstab" class="form-inline ewForm ewExtFilterForm" action="<?php echo ewr_CurrentPage() ?>">
<?php $SearchPanelClass = ($Page->Filter <> "") ? " in" : " in"; ?>
<div id="fUniversity_VS_Job_Offered_Candidatescrosstab_SearchPanel" class="ewSearchPanel collapse<?php echo $SearchPanelClass ?>">
...
<div id="c_YEAR__dateCreated" class="ewCell form-group">
	...
	<select id="YEAR__dateCreated" class="form-control" name="YEAR__dateCreated" onchange="ewrForms['fUniversity_VS_Job_Offered_Candidatescrosstab'].Submit();">
<?php
...
<script type="text/javascript">
fUniversity_VS_Job_Offered_Candidatescrosstab.Init();
fUniversity_VS_Job_Offered_Candidatescrosstab.FilterList = <?php echo $Page->GetFilterList() ?>;
</script>
<!-- Search form (end) -->
<?php } ?>
<?php } ?>
...
<?php include "University_VS_Job_Offered_Candidatesctbpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="University">
		<div class="University_VS_Job_Offered_Candidates_University"><span class="ewTableHeaderCaption"><?php echo $Page->University->FldCaption() ?></span></div>
	</td>
<?php } else { ?>
	<td data-field="University">
<?php if ($Page->SortUrl($Page->University) == "") { ?>
		<div class="ewTableHeaderBtn ewPointer University_VS_Job_Offered_Candidates_University" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->University) ?>',0);">
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_University_VS_Job_Offered_Candidates_University"<?php echo $Page->University->ViewAttributes() ?>><?php echo $Page->University->GroupViewValue ?></span></td>
<?php } ?>
<!-- Dynamic columns begin -->
<?php
...
<?php } ?>
	<!-- Bottom slot -->
<a id="cht_University_VS_Job_Offered_Candidates_University_Vs_Job_Position"></a>
<div class="">
<div id="div_ctl_University_VS_Job_Offered_Candidates_University_Vs_Job_Position" class="ewChart">
<div id="div_University_VS_Job_Offered_Candidates_University_Vs_Job_Position" class="ewChartDiv"></div>
<!-- grid component -->
<div id="div_University_VS_Job_Offered_Candidates_University_Vs_Job_Position_grid" class="ewChartGrid"></div>
</div>
</div>
<?php

// Set up chart object
$Chart = &$Table->University_Vs_Job_Position;
...
?>
<?php include_once "University_VS_Job_Offered_Candidates_University_Vs_Job_Positionchart.php" ?>
